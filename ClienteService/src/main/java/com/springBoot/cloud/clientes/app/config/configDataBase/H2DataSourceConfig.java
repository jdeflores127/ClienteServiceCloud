package com.springBoot.cloud.clientes.app.config.configDataBase;
...
@EnableJpaRepositories(
		...
		basePackages = {"com.springBoot.cloud.clientes.app.repositories"})
public class H2DataSourceConfig {
	...
	public LocalContainerEntityManagerFactoryBean personaEntityManagerFactory(){
		...
		//paso 2
		emf.setPackagesToScan("com.springBoot.cloud.clientes.app.entities");
